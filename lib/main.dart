...
void main() {
  runApp(
    MaterialApp( //contiene todos los demás witgets
      home: Scaffold(
        backgroundColor: Color.fromARGB(226, 247, 152, 74),
        appBar: AppBar(
          elevation: 0,
              ...
              Row(children: [
                  Expanded(child: 
                    Container(
                      ...
                      color: Colors.red,
                      child: Image.network(
                        "https://images.pexels.com/photos/12737062/pexels-photo-12737062.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
